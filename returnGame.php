...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT v.game_name, v.game_img,rv.rent_start_date, rv.rent_end_date, rv.fare, rv.id FROM rentedgames rv, videogame v
    WHERE rv.customer_username='$login_customer' AND v.game_id=rv.game_id AND rv.return_status='NR'";
...
<div class="container">
    ...
    <br>
    <br>
    <h1 class="text-center" style = "position:fixed;"><b>Return Borrowed Games</b></h1>
  <br>
  <br>
  <br>
...
?></td>
<td><a href="funcReturn.php?id=<?php echo $row["id"];?>"> Return </a></td>
</tr>
<?php        } ?>
                </table>
                </div> 
        <?php } else {
            ...
            <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">No Videogames to return.</h1>
        <p class="text-center" href = "index.php"> Rent New Games Here</p>
      </div>
    </div>
