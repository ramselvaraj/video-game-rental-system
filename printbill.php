...
$sql0 = "SELECT rv.id, rv.rent_end_date, rv.rent_start_date,rv.total_amount, v.game_name, v.game_img,v.platform FROM rentedgames rv, videogame v WHERE id = '$id' AND v.game_id = rv.game_id";
